...
var fileUploader = angular.module('snapChicApp.uploader', ['ngRoute'])
...
fileUploader.directive('fileUpload', function(httpPostFactory) {
    return {
      restrict: 'A',
...
fileUploader.factory('httpPostFactory', function($http) {
